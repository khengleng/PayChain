...
class Configuration
{
     ...
     * @var string
     */
    protected string $host = 'https://api.paychain.cambobia.com';
    ...
    {
        $report  = 'PHP SDK (PayChainSdk) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings(): array
    {
        return [
            [
                "url" => "https://api.paychain.cambobia.com",
