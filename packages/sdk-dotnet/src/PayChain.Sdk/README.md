...
inputSpec: /tmp/paychain-openapi.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{89AD2722-06B0-439F-A033-43C20C9327D5}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IActivateAssetApiResponse apiResponse = await api.ActivateAssetAsync("todo");
            Asset? model = apiResponse.Ok();
        }
...
## Api Information
- appName: PayChain Public API
- appVersion: 0.1.0
- appDescription: Tenant-facing API for loyalty integrations today and stablecoin workflows once readiness gates pass. The TypeScript SDK is published separately; other platforms can integrate directly from this contract.
