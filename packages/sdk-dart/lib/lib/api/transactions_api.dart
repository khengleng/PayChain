...
class TransactionsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Compensation] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Compensation>> approveCompensation({ 
    ...
    final _path = r'/api/v1/transactions/compensations/{compensationId}/approve'.replaceAll('{' r'compensationId' '}', encodeQueryParameter(_serializers, compensationId, const FullType(String)).toString());
    ...
    Compensation? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(Compensation),
      ) as Compensation;
  ...
  /// Returns a [Future] containing a [Response] with a [Compensation] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Compensation>> createCompensation({ 
    required String transactionId,
    required String idempotencyKey,
    required CompensationRequest compensationRequest,
    String? xCorrelationId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/transactions/{transactionId}/compensate'.replaceAll('{' r'transactionId' '}', encodeQueryParameter(_serializers, transactionId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (xCorrelationId != null) r'X-Correlation-Id': xCorrelationId,
    ...
    try {
      const _type = FullType(CompensationRequest);
      _bodyData = _serializers.serialize(compensationRequest, specifiedType: _type);
  ...
  Future<Response<Transaction>> getTransaction({ 
    ...
    final _path = r'/api/v1/transactions/{transactionId}'.replaceAll('{' r'transactionId' '}', encodeQueryParameter(_serializers, transactionId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (xCorrelationId != null) r'X-Correlation-Id': xCorrelationId,
  ...
  ///
  /// Parameters:
  /// * [limit] - Maximum number of rows to return. The API caps this at 200.
  /// * [xCorrelationId] - Optional caller-supplied correlation id echoed through logs and audit records.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
