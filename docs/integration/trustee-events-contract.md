...
[`API-CONTRACT.md`](./API-CONTRACT.md); this document adds the **inner signed artifacts** that let
PayChain act on authorizations and reserve evidence — not just log them.
